package org.utt.app.appmnt;

import javax.swing.*;

import org.utt.app.AppMntFrame;
...
public class MainCalendarPanel extends JPanel {
     ...
     */
    public MainCalendarPanel(AppMntFrame mainFrame) {
    ...
    private void drawCalendarPanel() {
        calendarPanel = new CalendarPanel(MainCalendarPanel.this);
        add(calendarPanel);
    }
    ...
    private void drawDayDetailPanel() {
        dayDetailPanel = new DayDetailPanel(MainCalendarPanel.this);
        add(dayDetailPanel);
    }
