...
public class OpdFormPanel extends JPanel implements Observer{
	 ...
	 *  
	 */
	public OpdFormPanel(final ObjectOPD oUserInfo) {
		super();
	...
	public void panelreport(final String formcode,final String type,final String clinic_name,final String clinic_scan,final String form_clinic_name,final String page){
