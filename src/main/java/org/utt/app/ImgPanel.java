...
import org.utt.app.opd.OpdFormPanel;
import org.utt.app.util.DateLabelFormatter;
import org.utt.app.util.Setup;

public class ImgPanel extends JPanel implements  Observer{
	ObjectOPD oUserInfo;
	Dimension screen;
	 ...
	 * 
	 */
	public ImgPanel(ObjectOPD oUserInfo) {
		super();
		...
		split.setRightComponent(topMainPanel);
	    ...
	    tabbedPane.addTab("<html>I<br>N<br>F<br>O </html>", null, split, "Patient Info");
	...
	public void setLeft(){
		...
		topMainLeftPanel.setBackground(new Color(208, 217, 237));
		...
		LabelListdata.setBounds(30,5,100,20);
		...
		bottomPanel.setBackground(new Color(208, 217, 237));
		...
		ButtonRefresh.setBackground(new Color(208, 217, 237));
	...
	public void setTop(){
		...
		topMainPanel.setPreferredSize(new Dimension(screen.width-((screen.width*2)/10), screen.height-140));
		topMainPanel.setBackground(new Color(243, 223, 208));  
		
		
			
		pt_info = new JPanel();		 
		pt_info.setLayout(null);
		pt_info.setBackground(new Color(243, 223, 208));
		topMainPanel.add(pt_info, BorderLayout.NORTH);
		...
		picker.setBackground(new Color(243, 223, 208));
		picker.getJFormattedTextField().setBackground(new Color(243, 223, 208));
		...
		jPanel = new JPanel();
		jPanel.setBounds(30, 4, 220, 40);
		jPanel.setBackground(new Color(243, 223, 208));
		...
		textArea.setBackground(new Color(243, 223, 208));
		...
		Label_Memo.setBackground(new Color(243, 223, 208));
		...
		Label_Extra.setBackground(new Color(243, 223, 208));
		...
		Label_Extra1.setBackground(new Color(243, 223, 208));
        ...
        try {
			video = new VideoCapture(580, 380, 24, videoDevices.get(0));
			//VideoDisplay<MBFImage> display = VideoDisplay.createVideoDisplay(video);
			videoDisplayPanel=new JPanel();
			videoDisplayPanel.setPreferredSize(new Dimension(580, 380));
			videoDisplayPanel.setBounds(100,130, 580, 300);
