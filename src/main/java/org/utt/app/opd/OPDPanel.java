...
public class OPDPanel extends JPanel implements  Observer{
	...
	public void setLeft(){
		...
		PtStatus1.setBackground(new Color(208, 217, 237));
		...
		PtStatus1.setBounds(160, 5, 40, 25);
		topMainLeftPanel.add(PtStatus1);
		
		PtStatus2 = new JRadioButton("New");
		PtStatus2.setBackground(new Color(208, 217, 237));
		...
		PtStatus2.setBounds(200, 5, 50, 25);
